...
public class BigTestDataSetupConfig implements ApplicationRunner {
  ...
  @Autowired private ProjectBigDataTestService projectBigDataTestService;

  public BigTestDataSetupConfig(
      ProjectBigDataTestService projectBigDataTestService,
      Environment env,
  ...
  private ArrayList<String> getTagList() {
    ...
    links.add(post("KI"));
    links.add(post("Maschinen"));
    links.add(post("Restful"));
    links.add(post("CSS"));
    links.add(post("HTTP"));
    links.add(post("JS"));
    links.add(post("Roboter"));
    links.add(post("Integralrechnung"));
    links.add(post("FP"));
    links.add(post("Smartphone"));
    links.add(post("Uhren"));
    links.add(post("Messungen"));
    links.add(post("NOSQL"));
    links.add(post("BigData"));
  ...
  public String post(String name) {
    ...
    if (link == null) {
      ...
      try {
        ...
        logger.info(
            jsonNode.get("_embedded").get("tags").elements().next().get("_links").toString());
        logger.info(
            jsonNode
                .get("_embedded")
                .get("tags")
