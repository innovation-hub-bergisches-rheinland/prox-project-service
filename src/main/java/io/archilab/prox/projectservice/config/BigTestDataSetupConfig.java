...
public class BigTestDataSetupConfig implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		List<String> prof_words = Arrays.asList("Schmidt", "Heiner", "Klaus", "Peter", "Marie", "Heide", "Julian", "Bente",
				"Klocke", "Köhler", "Johannes", "Alken", "Felix", "Berg", "Bergstein", "Böhmer", "Lambers", "Lau", "Uria",
				"Lucia", "Iris", "Michael");
		...
		for (int i = 0; i < testAmount; i++) {
			...
			newProject = new Project(projectName, shortDescription, description, status, requirement, creatorID, creatorName,
					supervisorName, modules);
