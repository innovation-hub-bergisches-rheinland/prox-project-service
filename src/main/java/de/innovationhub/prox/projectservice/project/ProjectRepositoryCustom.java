...
public interface ProjectRepositoryCustom {
  ...
  List<Project> findAvailableProjectsOfCreator(final UUID creatorId,
      Sort sort);

  @RestResource(exported = true, path = "findRunningProjectsOfCreator")
  List<Project> findRunningProjectsOfCreator(final UUID creatorId,
      Sort sort);

  @RestResource(exported = true, path = "findFinishedProjectsOfCreator")
  List<Project> findinishedProjectsOfCreator(final UUID creatorId,
      Sort sort);

  @RestResource(exported = true, path = "findRunningAndFinishedProjectsOfCreator")
  List<Project> findRunningAndFinishedProjectsOfCreator(final UUID creatorId,
      Sort sort);
