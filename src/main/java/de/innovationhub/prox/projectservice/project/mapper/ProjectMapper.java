...
public abstract class ProjectMapper {
  @Autowired
  private ProjectPermissionEvaluatorHelper permissionEvaluatorHelper;
  ...
  public abstract void updateProject(@MappingTarget Project projectToUpdate, CreateProjectDto updated);
}
