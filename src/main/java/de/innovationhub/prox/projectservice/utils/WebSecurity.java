...
public class WebSecurity {
   ...
   *
   * <p>The users will be compared by obtaining the UUID from the request using the autowired {@link
   * AuthenticationUtils} and selecting the creator of the project
   *
   ...
   * @param projectRepository Instance of projectRepository to obtain the associated project of
   *     <code>projectId</code>
   * @return <code>true</code> if requesting user and project creator are the same, otherwise <code>
   *     false</code>
   */
  public boolean checkProjectCreator(
      HttpServletRequest request, UUID projectId, ProjectRepository projectRepository) {
