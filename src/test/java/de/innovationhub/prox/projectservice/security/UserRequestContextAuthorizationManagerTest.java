...
class UserRequestContextAuthorizationManagerTest {
  ...
  private final UserRequestContextAuthorizationManager manager =
      new UserRequestContextAuthorizationManager();
  ...
  void shouldReturnFalseWhenAuthenticationIsNotAKeycloakToken() {
    var context =
        new RequestAuthorizationContext(
            new MockHttpServletRequest(), Map.of("userId", UUID.randomUUID().toString()));
  ...
  void shouldReturnTrueWhenUserIsEqualToVariable() {
    ...
    var context =
        new RequestAuthorizationContext(
            new MockHttpServletRequest(), Map.of("userId", userId.toString()));
