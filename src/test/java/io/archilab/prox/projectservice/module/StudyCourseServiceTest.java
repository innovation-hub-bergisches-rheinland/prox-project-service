...
class StudyCourseServiceTest {
  ...
  List<StudyCourse> sampleStudyCourseList() throws MalformedURLException {
    ...
    wirtschaftsinformatik.setExternalStudyCourseID(new ExternalStudyCourseID(new URL("http://example.org")));
    ...
    medieninformatik.setExternalStudyCourseID(new ExternalStudyCourseID(new URL("http://example.org")));
    ...
    computerScience.setExternalStudyCourseID(new ExternalStudyCourseID(new URL("http://example.org")));
  ...
  void setUp() throws Exception {
    ...
    studyCourseService = new StudyCourseService(studyCourseClient, moduleRepository, studyCourseRepository);
  }
  ...
  void when_study_course_import_then_all_saved() throws Exception {
    ...
    for(StudyCourse sc : sampleStudyCourseList()) {
      assertTrue(studyCourseRepository.findByExternalStudyCourseID(sc.getExternalStudyCourseID()).isPresent());

      for(Module module : sc.getModules()) {
        assertTrue(moduleRepository.findByExternalModuleID(module.getExternalModuleID()).isPresent());
      }
    }
  }
  ...
  void when_studycourses_with_no_modules_saved_cleanup_deletes() {
    StudyCourse studyCourseWithNoModules1 = new StudyCourse(new StudyCourseName("Study Course with no modules"), AcademicDegree.BACHELOR);
    StudyCourse studyCourseWithNoModules2 = new StudyCourse(new StudyCourseName("Study Course with no modules"), AcademicDegree.MASTER);
  ...
  @Test
  void when_studycourses_with_mixed_modules_saved_cleanup_deletes_only_study_courses_without_modules() {
    StudyCourse studyCourseWithNoModules1 = new StudyCourse(new StudyCourseName("Study Course with no modules"), AcademicDegree.BACHELOR);
    StudyCourse studyCourseWithNoModules2 = new StudyCourse(new StudyCourseName("Study Course with modules"), AcademicDegree.MASTER);
