...
>>>>>>> branch 'gp-ws2019' of https://github.com/Archi-Lab/prox-project-service
  ...
  public void addTags() {
    ...
    Project project1 = new Project(new ProjectName("Projekt1"),
        new ProjectShortDescription("mini inhalt"), new ProjectDescription("Projekt1"),
        ProjectStatus.LAUFEND, new ProjectRequirement("ALl done"), new CreatorID(UUID.randomUUID()),
        new CreatorName("ein Name"), new SupervisorName("Name2"), modules, tags1);
    Project project2 = new Project(new ProjectName("Projekt2"),
        new ProjectShortDescription("mini inhalt"), new ProjectDescription("Projekt1"),
        ProjectStatus.LAUFEND, new ProjectRequirement("ALl done"), new CreatorID(UUID.randomUUID()),
        new CreatorName("ein Name"), new SupervisorName("Name2"), modules, tags2);
